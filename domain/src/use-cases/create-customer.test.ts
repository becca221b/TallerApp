...
import { createMockCustomerService } from "../mocks/mock-customer-service.js";
...
describe('Create a customer',()=>{
    ...
    it('should throw error if customerName is empty', async()=>{
        const mockCustomerService = createMockCustomerService();
        const createCustomerUseCase = new (await import('./create-customer.js')).CreateCustomer(mockCustomerService);
        const newCustomer: Customer = {
            id: '2',
            customerName: '',
            phone: 5555678,
