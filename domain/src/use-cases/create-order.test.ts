...
describe('Create an order',()=>{
    ...
    let mockOrderService = createMockOrderService();

    const customer:Customer= {id:'1', customerName:'Rebeca', address:'Calle Falsa 123', phone:1234567890};
    const garment:Garment = {id:'1', name:'shirt', description:'', price:50, color:'red', imageUrl:'', neck:'round', cuff:'none', flap:'none', zipper:'none', pocket:'none', waist:'elastic'};
